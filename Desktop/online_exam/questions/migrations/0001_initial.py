    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2021, 7, 28, 10, 2, 28, 87674))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 7, 28, 10, 2, 28, 87674))),
                ('professor', models.ForeignKey(limit_choices_to={'groups__name': 'Professor'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
